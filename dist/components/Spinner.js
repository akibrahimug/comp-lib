...
export function LoadingOverlay({ message = 'Loading...', show = true, }) {
    if (!show)
        return null;
    return (_jsxs("div", { className: "fixed inset-0 z-50 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm", role: "status", "aria-live": "polite", "aria-label": message, children: [_jsx(Spinner, { size: "xl", color: "brand", className: "mb-4" }), _jsx("p", { className: "text-sm font-medium text-gray-700", children: message })] }));
}
