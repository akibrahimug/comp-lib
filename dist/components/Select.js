 ...
 */
export const Select = forwardRef(function Select({ label, description, error, invalid, size = 'md', disabled, className, tw, id: providedId, children, ...props }, ref) {
    ...
    const chevronIcon = (_jsx("svg", { className: "absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500", width: "16", height: "16", viewBox: "0 0 15 15", fill: "none", children: _jsx("path", { d: "M4.18179 6.18181C4.35753 6.00608 4.64245 6.00608 4.81819 6.18181L7.49999 8.86362L10.1818 6.18181C10.3575 6.00608 10.6424 6.00608 10.8182 6.18181C10.9939 6.35755 10.9939 6.64247 10.8182 6.81821L7.81819 9.81821C7.73379 9.9026 7.61934 9.95001 7.49999 9.95001C7.38064 9.95001 7.26618 9.9026 7.18179 9.81821L4.18179 6.81821C4.00605 6.64247 4.00605 6.35755 4.18179 6.18181Z", fill: "currentColor", fillRule: "evenodd", clipRule: "evenodd" }) }));
    return (_jsxs("div", { className: "w-full", children: [label && (_jsx("label", { htmlFor: id, className: "block text-sm font-medium text-gray-700 mb-1", children: label })), description && !error && (_jsx("p", { id: descriptionId, className: "text-sm text-gray-600 mb-2", children: description })), _jsxs("div", { className: "relative", children: [_jsx("select", { ref: ref, id: id, disabled: disabled, "aria-invalid": isInvalid || undefined, "aria-describedby": cx(descriptionId, errorId), className: selectClasses, ...props, children: children }), chevronIcon] }), error && (_jsx("p", { id: errorId, className: "mt-1 text-sm text-danger-600", role: "alert", children: error }))] }));
});
