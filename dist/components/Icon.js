 ...
 */
export const Icon = forwardRef(function Icon({ name, size, className, tw, ...props }, ref) {
    const d = icons[name];
    const filled = FILLED.has(name);
    return (_jsx("svg", { ref: ref, viewBox: "0 0 24 24", width: size, height: size, fill: filled ? 'currentColor' : 'none', stroke: filled ? 'none' : 'currentColor', strokeWidth: 1.75, strokeLinecap: "round", strokeLinejoin: "round", className: mergeTw(size ? undefined : 'h-5 w-5', className, tw), "aria-hidden": "true", ...props, children: d ? _jsx("path", { d: d }) : null }));
});
