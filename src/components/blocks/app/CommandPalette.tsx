...
const CommandPaletteInput = forwardRef<HTMLInputElement, CommandPaletteInputProps>(
  function CommandPaletteInput({ value, onValueChange, placeholder, className, tw }, ref) {
    return (
...
const CommandPaletteGroup = forwardRef<HTMLDivElement, CommandPaletteGroupProps>(
  function CommandPaletteGroup({ label, children, className, tw, ...rest }, ref) {
...
const CommandPaletteItem = forwardRef<HTMLButtonElement, CommandPaletteItemProps>(
